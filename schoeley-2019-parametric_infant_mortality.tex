...
\documentclass[smallextended]{svjour3} % smallcondensed, smallextended, twocolumn
...
AXA Insurance.} }
    ...
    \titlerunning{The Age-Trajectory of Infant Mortality}

%\author{  Jonas Schöley \and  }
...
\addcontentsline{toc}{section}{The age-trajectory of US infant
mortality}
...
\addcontentsline{toc}{section}{Evidence for an exponentially-truncated
power hazard}
...
\addcontentsline{toc}{subsection}{Negative Gompertz hazard}
...
\addcontentsline{toc}{subsection}{Power-law hazard}
...
\addcontentsline{toc}{subsection}{Exponentially-truncated power-law
hazard}
...
\addcontentsline{toc}{section}{Evaluation of the truncated power hazard}
...
\addcontentsline{toc}{section}{Interpretation of the truncated power
hazard}

\subsection*{A shock-recovery process}\label{a-shock-recovery-process}
\addcontentsline{toc}{subsection}{A shock-recovery process}
...
\addcontentsline{toc}{subsection}{A mortality selection process}
